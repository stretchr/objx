...
// BoolSlice gets the value as a []bool.
//
// Panics if the object is not a []bool.
...
// IntSlice gets the value as a []int.
//
// Panics if the object is not a []int.
...
// Int8Slice gets the value as a []int8.
//
// Panics if the object is not a []int8.
...
// Int16Slice gets the value as a []int16.
//
// Panics if the object is not a []int16.
...
// Int32Slice gets the value as a []int32.
//
// Panics if the object is not a []int32.
...
// Int64Slice gets the value as a []int64.
//
// Panics if the object is not a []int64.
...
// UintSlice gets the value as a []uint.
//
// Panics if the object is not a []uint.
...
// Uint8Slice gets the value as a []uint8.
//
// Panics if the object is not a []uint8.
...
// Uint16Slice gets the value as a []uint16.
//
// Panics if the object is not a []uint16.
...
// Uint32Slice gets the value as a []uint32.
//
// Panics if the object is not a []uint32.
...
// Uint64Slice gets the value as a []uint64.
//
// Panics if the object is not a []uint64.
...
// UintptrSlice gets the value as a []uintptr.
//
// Panics if the object is not a []uintptr.
...
// Float32Slice gets the value as a []float32.
//
// Panics if the object is not a []float32.
...
// Float64Slice gets the value as a []float64.
//
// Panics if the object is not a []float64.
...
// Complex64Slice gets the value as a []complex64.
//
// Panics if the object is not a []complex64.
...
// Complex128Slice gets the value as a []complex128.
//
// Panics if the object is not a []complex128.
